      ...
      <div class="flex flex-col h-full">
            ...
            <li>
              ...
              <div v-if="showCategories" class="ml-8 mt-2 space-y-1">
                <router-link
                  ...
                  @click="$emit('close')"
                  class="block px-3 py-2 text-sm text-gray-600 hover:text-primary-600 hover:bg-primary-50 rounded-md transition-colors"
                >
                  {{ category.name }}
                </router-link>
              </div>
        ...
        <div class="border-t border-gray-200 p-4 space-y-3">
          ...
          >
            ...
            <span v-if="cartStore.cartItemCount > 0" class="bg-white text-primary-600 text-xs rounded-full h-5 w-5 flex items-center justify-center">

<template>
    <div class="fixed bottom-6 right-6 z-50">
        <a
            ...
            class="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 text-white shadow-lg transform transition-all duration-300 hover:scale-110"
            aria-label="Chat with us on WhatsApp"
        >
            <svg
                class="transition-all duration-300 group-hover:scale-110 h-32 w-32"

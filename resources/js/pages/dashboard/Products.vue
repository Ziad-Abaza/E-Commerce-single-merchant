    ...
    <div class="p-2 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <div class="flex gap-2">
                        <button
                            ...
                            :class="
                                showTrashed ? 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300' : 'bg-blue-600 text-white'
                            "
        ...
        >
            <div class="flex flex-col sm:flex-row gap-3 items-end">
                ...
                <Select
                    ...
                    label="Category"
                    @update:modelValue="handleCategoryFilter"
                />

                <!-- Status Filter -->
                <Select
                    v-model="productsStore.filters.status"
        ...
        >
            ...
            <div v-else-if="showTrashed">
                ...
                <div
                    v-if="productsStore.trashedProducts.length === 0"
                    class="text-center py-12"
                >
                ...
                <div v-else>
                    <Table
                        :headers="trashedTableHeaders"
                        :rows="trashedTableRows"
                    />
                </div>
            </div>
            <div v-else>
        ...
        >
            ...
            >
                <Pagination
                    ...
                    :from="productsStore.pagination.from"
                    :to="productsStore.pagination.to"
        ...
        <DetailsModal
            ...
            :show="productsStore.showDetailsModal"
            :item="productsStore.currentProduct"
            :editable="true"
            title="Product Information"
            subtitle="Complete information about this product"
            image-section-title="Product Image"
            id-label="Product ID"
            @close="productsStore.showDetailsModal = false"

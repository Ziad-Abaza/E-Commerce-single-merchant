        ...
        >
          <td
            ...
            :class="[
                ...
                row[headers]?.type === 'image' ? 'px-2 py-2' : 'px-6 py-4'
            ]"
            >
            ...
            <template v-if="row[headers]?.type === 'image'">
              <img
                ...
                @click="$emit('preview', row[headers].full || row[headers].src)"
              />
            </template>
            ...
            <!-- Actions Cell -->
            <template
              v-else-if="Array.isArray(row[headers]) && isActionArray(row[headers])"
            >
